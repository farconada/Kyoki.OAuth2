class demoapp {
	...
	file {'/var/www/FLOW3/Packages/Applications/Acme.Demoapp':
	    ensure => directory,
	...
	exec {'demoapp-createaccount':
    		...
    		cwd => '/var/www/FLOW3',
    		require => [Exec['flow3-checkout'], File['/var/www/FLOW3/Packages/Applications/Acme.Demoapp'],Exec['flow3-dbupdate']]
